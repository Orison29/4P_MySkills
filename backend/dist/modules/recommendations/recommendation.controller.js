...
exports.getProjectRecommendationsHandler = exports.getEmployeeSkillAnalysisHandler = exports.getRecommendedEmployeesHandler = void 0;
const recommendation_service_1 = require("./recommendation.service");
/**
 * Get recommended employees for a deliverable
 * GET /api/deliverables/:deliverableId/recommendations?topK=5
 */
const getRecommendedEmployeesHandler = async (req, res) => {
    try {
        ...
        const recommendations = await (0, recommendation_service_1.getRecommendedEmployees)(deliverableId, topK);
        res.status(200).json({
            deliverableId,
            topK,
...
exports.getRecommendedEmployeesHandler = getRecommendedEmployeesHandler;
/**
 ...
 */
const getEmployeeSkillAnalysisHandler = async (req, res) => {
    try {
        ...
        const employeeId = Array.isArray(rawEmployeeId)
            ? rawEmployeeId[0]
            : rawEmployeeId;
        const analysis = await (0, recommendation_service_1.getEmployeeSkillAnalysis)(deliverableId, employeeId);
...
exports.getEmployeeSkillAnalysisHandler = getEmployeeSkillAnalysisHandler;
/**
 * Get recommendations for ALL deliverables in a project
 * GET /api/projects/:projectId/recommendations?topK=5
 */
const getProjectRecommendationsHandler = async (req, res) => {
    try {
        ...
        const recommendations = await (0, recommendation_service_1.getProjectRecommendations)(projectId, topK);
...
exports.getProjectRecommendationsHandler = getProjectRecommendationsHandler;
